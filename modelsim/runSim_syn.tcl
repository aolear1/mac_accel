...
set SDF_FOLDER "/ubc/ece/home/ugrads/a/aolear01/CPEN402/lab3/v3/outputs"

# Starting the simulator
vsim -default_radix unsigned -voptargs=+acc -sdfnoerror +neg_tchk +no_notifier -sdfmax /$TB_NAME/$TOP_LEVEL=$SDF_FOLDER/${TOP_LEVEL}_v1_map.sdf -l $TB_NAME.sim.log work.${TB_NAME} 
